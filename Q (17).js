...
let place = ["Muree", "Saif-ul-Malook", "Kaghan", "Charna-Island", "Abbotabad"];

console.log("Original Order");
console.log(place);

console.log("Sorted in Alphabetical Order");
console.log(place.slice().sort());

console.log("Still in Original Order");
console.log(place);

console.log("Reverse Order");
console.log(place.slice().reverse());
...
console.log("Reverse again and Back to Original Order");
console.log(place.reverse());
